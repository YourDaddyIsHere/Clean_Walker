...
class Test_Walker(unittest.TestCase):
    ...
    def test_is_in_list(self):
        ...
        assert_true(self.candidate_group.is_in_list(tracker,self.candidate_group.trusted_candidates))
    def test_add_candidate_to_walk_list(self):
        ...
        assert_true(self.candidate_group.is_in_list(candidate,self.candidate_group.walk_candidates))
    def test_add_candidate_to_stumble_list(self):
        ...
        assert_true(self.candidate_group.is_in_list(candidate,self.candidate_group.stumble_candidates))
    def test_add_candidate_to_intro_list(self):
        ...
        assert_true(self.candidate_group.is_in_list(candidate,self.candidate_group.intro_candidates))
    ...
    def test_get_candidate_to_introduce(self):
        ...
        assert_false(candidate_group2.is_in_list(candidate4,candidate_group2.stumble_candidates))
        assert_false(candidate_group2.is_in_list(candidate5,candidate_group2.stumble_candidates))