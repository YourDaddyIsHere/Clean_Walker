...
class Test_Walker:
    ...
    def test_decode_introduction_request(self):
        ...
        assert_equals(message.source_lan_address,message_decode.source_lan_address)
        assert_equals(message.source_wan_address,message_decode.source_wan_address)
    def test_decode_introduction_response(self):
        ...
        assert_equals(message.source_lan_address,message_decode.source_lan_address)
        assert_equals(message.source_wan_address,message_decode.source_wan_address)
        assert_equals(message.lan_introduction_address,message_decode.lan_introduction_address)
        assert_equals(message.wan_introduction_address,message_decode.wan_introduction_address)
    def test_decode_puncture_request(self):
        ...
        assert_equals(message.lan_walker_address,message_decode.lan_walker_address)
        assert_equals(message.wan_walker_address,message_decode.wan_walker_address)
